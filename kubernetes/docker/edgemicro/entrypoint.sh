...
if [[ ${EDGEMICRO_PROCESSES} != "" ]]; then
  commandString="cd /opt/apigee && export EDGEMICRO_DECORATOR=$EDGEMICRO_DECORATOR && edgemicro start -p $EDGEMICRO_PROCESSES -o $EDGEMICRO_ORG -e $EDGEMICRO_ENV -k $EDGEMICRO_KEY -s $EDGEMICRO_SECRET &"
else
